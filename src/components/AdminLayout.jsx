...
export default function AdminLayout() {
    ...
    const menuItems = [
        ...
        { name: "Class", icon: Dumbbell, path: "/dashboard/admin/classes" },
        { name: "Membership", icon: Crown, path: "/dashboard/admin/memberships" },
        { name: "Trainer", icon: Users, path: "/dashboard/admin/trainers" },
        { name: "Schedule", icon: Calendar, path: "/dashboard/admin/schedules" },
        { name: "Booking", icon: Ticket, path: "/dashboard/admin/bookings" },
        { name: "Payment", icon: CreditCard, path: "/dashboard/admin/payments" },
    ];
                    ...
                    <div className="p-4 border-t border-gray-100">
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="font-semibold text-athletica-blue-dark truncate">Admin</p>
                                <p className="text-xs text-gray-500 truncate">admin@athletica.com</p>
                            </div>
                        </div>
                        <button
